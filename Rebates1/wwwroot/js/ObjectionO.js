...
function load() {
   /* window.alert(property_key);*/
    ...
    if (property_key == "Res") {
        ...
        $(".div3_R").toggle(2000);
        $(".div4_R").toggle(2000);
        document.getElementById("form_head").innerHTML = "FORM A: RESIDENTIAL (FULL TITLE AND SECTIONAL  TITLE USED FOR RESIDENTIAL PURPOSES)";
         
    }
    //Agricultural focus hide other sections
    if (property_key == "Agric") {
        ...
        $("#section4-res").hide();
        $(".div3_A").toggle(2000);
        document.getElementById("form_head").innerHTML = "FORM C: AGRICULTURAL HOLDINGS OR FARMS";
    }
    //Business focus hide other sections
    if (property_key == "Bus") {
        $("#section1").show();
        $("#section2").show();
        $("#section3-agric").hide();
        ...
        $(".div3_B").toggle(2000);
        $(".div4_B").toggle(2000);
        document.getElementById("form_head").innerHTML = "FORM B: PROPERTIES OTHER THAN RESIDENTIAL OR AGRICULTURAL (e.g. BUSINESSES, FACTORIES, OFFICES,SCHOOLS)";
    }
    //Owner
